...
Export selected dates by clicking the top left download button


<center>

![Export selected dates](`r panel.map.export`){width=250px}

</center>

Dates will be exported as a GeoJSON file that can be analysed in a GIS or used in the [NeoNet R package](https://github.com/zoometh/neonet#neonet-package)
...
* the DOI exists:
Add the complete DOI to the field: `https://10.1016/j.jaa.2016.01.007`
...
- <input type="checkbox" checked> create a `get_neonet()` connector to the **dataset** with the [c14bazAAR getter function](https://github.com/ropensci/c14bazAAR) </input>
