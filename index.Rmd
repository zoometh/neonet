...
author: "<span style='font-size: 15px'>Thomas Huet, Niccolo Mazzucco, Miriam Cubas, J. Francisco Gibaja, F. Xavier Oms, António Faustino Carvalho, Ana Catarina Basilio</style>"
# date: "11/12/2020"
header-includes:
  - \usepackage{float}u
...
NeoNet brings together many of the dates already published. The most frequent work is to check the quality and standardise the archaeological information. here are a workflow that can save you time:
