...
#'
#' @description Create a reference XLSX file used to map external dbs to Neonet periods (class) (..., LM, EN, ...). The XLSX file can be read later by the function `neo_dbs_align()`. c14bazAAR (`db_period` and `db_culture`)  
#'
