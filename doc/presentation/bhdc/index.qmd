...
title-slide-attributes:
    data-background-image: "img/watersheds-ortho.png"
...
format:
  revealjs: 
    ...
    logo: https://raw.githubusercontent.com/zoometh/neonet/master/doc/presentation/bhdc/img/watersheds-ortho.png
...
::: {.notes}
To facilitate dataset curation, it has been divided into two parts based on river basins: NeoNet Atl, focusing on the Atlantic region (in blue), and NeoNet Med, dedicated to the central northern Mediterranean (in red). The decision to partition by river basins is grounded in two primary considerations: it allows for the systematic breakdown, or hierarchical decomposition, of river basins into interconnected and nested components; watersheds are crucial as spatial analysis units, facilitating mathematical modeling that incorporates key concepts such as catchment area, thalweg (shortest path), and natural boundaries.
:::
...
<div class="column50">![](https://raw.githubusercontent.com/zoometh/neonet/master/results/atl_test1.png)
<div class="captiontext">Summed probability densities (SPD)</div>
</div>
<div class="column50">![](https://raw.githubusercontent.com/zoometh/neonet/master/results/figure1.png){height="700"}
...
::: {.notes}
Dates can be aggregated and seriated by periods (here), sites and period, archaeological layer (PhaseCode), or plotted individually
:::
...
::: {.notes}
NeoNet is one of the numerous radiocarbon datasets. That's why we have developed a *getter* function within the C14bazaar package for the dataset's to be harvestable.
:::
...
* Build sites' Harris matrices
* Run Bayesian analysis on-the-fly
...
* We would like to contruct the Harris matrices of different site and
* run Bayesian statistics to better the modeling
:::
