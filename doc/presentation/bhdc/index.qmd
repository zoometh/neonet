...
<div class="img">
![](img/neo_datasum_by_periods_samp.png){width="800"}
</div>
...
<div class="img">
![](img/donzere-view.png){width=1100px}
...
library(dplyr)
library(leaflet)
geojson_data <- st_read("https://raw.githubusercontent.com/zoometh/neonet/main/doc/presentation/bhdc/data/neonet-data-2023-10-22-select-aera.geojson")
...
library(dplyr)
library(leaflet)
geojson_data <- st_read("https://raw.githubusercontent.com/zoometh/neonet/main/doc/presentation/bhdc/data/neonet-data-2023-10-22.geojson")
leaflet(geojson_data) %>%
  addTiles() %>% 
