...
![](img/github-neonet-functions.png){width="700" style='horizontal-align: middle;'}
...
![](https://raw.githubusercontent.com/zoometh/neonet/master/doc/img/neonet_med_spd.png){width="700" style='horizontal-align: middle;'}

```{.r}
neo_spd(inData = "Roc du Dourgne_2023-07-30.csv")
```

![](https://raw.githubusercontent.com/zoometh/neonet/main/doc/img/app-strati-diag-dourgne-period.png){width="700" style='horizontal-align: middle;'}
