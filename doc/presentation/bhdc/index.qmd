...
<div class="img"><center>
![](https://raw.githubusercontent.com/zoometh/neonet/main/results/figure1.png){width="400" style='horizontal-align: middle;'}
</center></div>
...
::: {.notes}
The Shiny app comes with documentation and others functions to calculate SPDs, isochrones and Harrix matrices among other things.
:::
...
::: {.notes}
Finally, NeoNet is one among many radiocaborn datasets. That's why we prepared a getter function, in the C14bazaar package, for the dataset to be harvested.
:::
