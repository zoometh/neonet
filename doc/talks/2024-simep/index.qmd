...
::: notes
**8000 BC** Two main climates: `Csa` and `Csb`. First settlements in Cyprus (`Csa` climate)
**7000 BC** Same two main climates (`Csa` and `Csb`) + `BWh` and `BWk`. First settlements in Creta (`Csa` climate)
**6000 BC** ...
:::
