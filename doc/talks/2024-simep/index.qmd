...
::: {.column width="40%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-6200BC-EN.png" width="400">
:::
...
interpolated <- akima::interp(x = df$longitude, 
  ...
  interp_df <- tidyr::expand_grid(i = seq_along(interpolated$x), 
    ...
    dplyr::select(-i, -j)
```
<small>![neonet::neo_isochr_inter()](https://github.com/zoometh/neonet/blob/main/R/neo_isochr_inter.R)</small>
:::
...
::: {.column width="60%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/aDate-Le Baratin-Ly-4725.png-spd-align.png" width="650">
:::

::: {.column width="40%"}
<small><b>52</b>: Le Baratin, Ly-4725</small><br>
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/aDate-Le Baratin-Ly-4725-map.png" width="400">
:::
...
::: {.column width="60%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-6200BC-EN-kcc.png" width="400">
:::

::: {.column width="40%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-6200BC-EN-kcc-legend.png" width="350">
:::
...
# Spread of Neolithic the Mediterranean {background-image="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/bck-img-2-50perc.png"}
