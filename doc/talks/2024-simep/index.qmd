...
format:
  revealjs: 
    ...
    footer: "<em><b>Social Interactions in Mediterranean Prehistory  </b></em> <img src='https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/simep-logo.png' style='height: 20px;vertical-align: middle;'>  21-23 October 2024, Barcelona, Spain"
    margin: 0
    width: 1200
---
...
library(DT)
library(dplyr)
balkans <- "https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-barriere-Balkans-EN-kcc.tsv"
climate_df <- read.csv2(balkans, sep = "\t", header = TRUE)
...
* Neolithic expansion in the Southern Balkans was more rapid in areas with a mild climate and dry summers (<span style="color:#FFFF00;">Csa</span>).
* Northern expansion required adapting agriculture and stockbreeding systems to colder climates (<span style="color:#00FFFF;">Dfa</span>, <span style="color:#37C8FF;">Dfb</span>)
...
library(DT)
library(dplyr)
balkans <- "https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-barriere-Italy-EN-kcc.tsv"
climate_df <- read.table(balkans, sep = "\t", header = TRUE)
kcc_df <- "https://raw.githubusercontent.com/zoometh/neonet/master/inst/extdata/koppen.tsv"
kcc_colors  <- read.csv2(kcc_df, sep = "\t")
kcc_colors <- kcc_colors[ , c("code", "color")]
kcc_colors <- rbind(kcc_colors, c(NA, "#FFFFFF"))
...
* 5800-5600 BC: Rapid inland expansion between  in <span style="color:#FFFF00;">Csa</span>, for ex: La Marmotta (idf <b>94</b>) and Rio Tana (idf <b>149</b>), Central Italy
...
* Confirms: Mazzucco et al., 2023[^71], Binder et al., 2018[^72].
...
::: {.column width="70%"}
![](https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-5100BC-EN-kcc.png){width="700" style="horizontal-align: middle;"}
:::
