...
::: {.column width="50%"}
The most ancient <span style="color: blue;">EN</span> date median
![](https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2023-bhdc/img/median-en-baratin.png)
:::

::: {.column width="50%"}
The most recent <span style="color: red;">LM</span> date median
