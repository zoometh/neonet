...
dirIn <- "https://raw.githubusercontent.com/zoometh/neonet/main/doc/talks/2023-bhdc/data/"
```

::: columns
::: {.column width="50%"}
<small>`neonet-data-2023-10-22-select-aera.geojson`</small>

```{r}
df <- st_read(paste0(dirIn, "neonet-data-2023-10-22-select-aera.geojson"), quiet = T)
ID <- as.character(df$ID)
leaflet(df, width = "350px", height = "350px") %>%
  addTiles() %>%
...
::: {.column width="50%"}
<small>`neonet-data-2023-10-22.geojson`</small>
