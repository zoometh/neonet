...
::: {.column width="50%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/pub-joad.png" width="500"/>
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/pub-neonet-joad.png" width="500"/>
:::

::: {.column width="50%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2023-bhdc/img/watersheds-rivers.png" width="500"/>
:::
...
df.to.rm <- read.table(balkans, sep = "\t", header = TRUE)
df.to.rm$lon <- df.to.rm$lat <- NULL
df.to.rm %>% 
  DT::datatable(
    width = "100%",
    rownames = FALSE,
