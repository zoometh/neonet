...
### Farming Pioneer front


<span style="color:#0000CF; font-size: 25px;">Early Mesolithic (EM), </span>
<span style="color:#1D1DFF; font-size: 25px;">Middle Mesolithic (MM), </span>
<span style="color:#3737FF; font-size: 30px;">Late Mesolithic (LM), </span>
<span style="color:#FF1B1B; font-size: 30px;">Early Neolithic (EN), </span>
<span style="color:#FF8D1B; font-size: 25px;">Middle Neolithic (MN), </span>
<span style="color:#FFC04D; font-size: 25px;">Late Neolithic (LN)</span>

::: columns

::: {.column width="50%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/moments-dbs-meso-Montclus.png-spd.png" height="250" width="600"><br><small>Baume de Montclus, stacked SPD</small>
:::

::: {.column width="50%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/moments-dbs-neo-Franchti.png-spd.png" height="250" width="600"><br><small>Franchthi cave, stacked SPD</small>
:::
...
::: {.column width="50%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/pub-neonet-joad.png" width="600"/>
:::
...
leaflet(df, width = "300px", height = "300px") %>%
  addTiles() %>%
...
<small><https://github.com/EvolEcolGroup/pastclim/blob/master/R/koeppen_geiger.R></small>
:::
...
::: {.column width="60%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/aDate-Le Baratin-Ly-4725.png-spd-align.png" width="600">
:::

::: {.column width="40%"}
<img src="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/aDate-Le Baratin-Ly-4725-map.png" width="400"><br>
<small><b>52</b>: Le Baratin, Ly-4725</small>
:::
...
# Results {background-image="https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/bck-img-2-50perc.png"}

::: notes
Radiocarbon dates are still being revised, and many of them need to be verified. First modeling
:::

## Spread of Neolithic in Eastern and Central Mediterranean (in BC)
...
::: {.column width="50%"}
![](https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-7600BC-EN-kcc.png){width="400" style="horizontal-align: middle;"}
:::
...
::: {.column width="50%"}
![](https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-6800BC-EN-kcc.png){width="400" style="horizontal-align: middle;"}
:::
...
::: {.column width="50%"}
![](https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-6000BC-EN-kcc.png){width="400" style="horizontal-align: middle;"}
:::
...
::: {.column width="50%"}
![](https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-5800BC-EN-kcc.png){width="400" style="horizontal-align: middle;"}
:::
...
::: {.column width="50%"}
![](https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-5600BC-EN-kcc.png){width="400" style="horizontal-align: middle;"}
:::
...
## Spread of Neolithic in Western Mediterranean (in BC)
...
::: {.column width="50%"}
![](https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-5600BC-EN-kcc-west.png){width="400" style="horizontal-align: middle;"}
:::
...
::: {.column width="50%"}
![](https://raw.githubusercontent.com/zoometh/neonet/master/doc/talks/2024-simep/img/isochrones-5300BC-EN-kcc-west-legend.png){width="400" style="horizontal-align: middle;"}
:::
